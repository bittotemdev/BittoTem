TEMPLATE = app
TARGET = BittoTem-qt
macx:TARGET = "BittoTem-Qt"
VERSION = 0.7.2
INCLUDEPATH += src src/json src/qt
QT += core gui network
greaterThan(QT_MAJOR_VERSION, 4): QT += widgets
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE SCRYPT_CHACHA SCRYPT_KECCAK512 USE_IPV6
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/BittoTem-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
