...
int64 nChainStartTime = 1399125335;
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
 ...
 /*            if(fTestNet || (pindexLast->nHeight + 1 > 15000))
    ...
    if(pindexPrev->GetBlockTime() < 1399125000)
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=2b345ac4d3, nTime=1399125335, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        assert(block.hashMerkleRoot == uint256("0x4daf0c624ed5d86aa8a2192b4b0741277c18618bf65c60a98c2201652d6ba3d0"));
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if(currentTimestamp < 1399125335)
        {
        ...
        else if(currentTimestamp < 1399125335)
        {
            if (!pfrom->fClient && !pfrom->fOneShot &&
                (pfrom->nStartingHeight > (nBestHeight - 144)) &&
                (pfrom->nVersion < NOBLKS_VERSION_START ||
