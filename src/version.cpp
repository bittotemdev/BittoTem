...
// for both cacheoind and BittoTem-qt, to make it harder for attackers to
// target servers or GUI users specifically.

// WM - const std::string CLIENT_NAME("Satoshi");
const std::string CLIENT_NAME("BittoTem");
...
#    define GIT_COMMIT_DATE "Mar 20 2014, 20:20:20"
#endif

#define BUILD_DESC_FROM_COMMIT(maj,min,rev,build,commit) \
    "v" DO_STRINGIZE(maj) "." DO_STRINGIZE(min) "." DO_STRINGIZE(rev) "." DO_STRINGIZE(build) "-grp" commit
